...
import ProfileList from '@/components/ui/header/profile-list';

export default function DashboardHeader(): ReactNode {
  return (
    <header className='mobile:h-[3.75rem] tablet:pr-8 mobile:pr-2 border-gray-3 tablet:pl-48 mobile:pl-20 tablet:justify-end fixed top-0 right-0 left-0 z-50 flex h-[4.375rem] w-full items-center justify-between border-b-1 bg-white pr-20 pl-96'>
      ...
      <nav className='mobile:gap-2 flex items-center gap-8'>
        ...
        <div className='mobile:gap-4 flex gap-6'>
          <ProfileList />
          <div className='border-l-gray-3 mobile:pl-4 flex items-center gap-3 border-l-1 pl-6'>

...
export default function DashboardHeader(): ReactNode {
  ...
  return (
    <header className='mobile:h-[3.75rem] tablet:pl-48 mobile:pl-18 tablet:justify-end font-pretendard fixed top-0 right-0 left-0 z-20 flex h-[4.375rem] w-full items-center justify-between border-b-1 border-[var(--auth-border)] bg-[var(--auth-bg)] pl-84'>
      <div className='tablet:flex-1 text-xl font-bold text-[var(--auth-text-strong)]'>
        {title ? (
          <h1>{title}</h1>
        ) : (

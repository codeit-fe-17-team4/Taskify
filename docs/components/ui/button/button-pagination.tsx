...
export default function ButtonPagination({
  ...
  const buttonClassName =
    'border-[var(--auth-border)] flex-center *:fill-[var(--auth-text-strong)] disabled:*:fill-[var(--auth-placeholder)] h-9 w-9 cursor-pointer border-1 hover:bg-[var(--button-secondary-hover)] active:bg-[var(--button-secondary-hover)]';
